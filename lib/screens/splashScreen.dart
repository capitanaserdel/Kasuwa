...
class _WithBuilder extends State<WithBuilder> {
  ...
  List<ItemData> data = [
    ItemData(Colors.white, "assets/images/w.png", "Hi", "It's Me", "Sahdeep"),
    ItemData(Colors.black , "assets/images/g.png", "Take a", "Look At",
        "Liquid Swipe"),
    ItemData(Colors.white, "assets/images/facebook.png", "Liked?", "Fork!", "Give Star!"),
